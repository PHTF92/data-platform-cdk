...
class RDS_instance(core.Stack):
    """Class that creates a RDS database instance (postgrees) and the support resources such as VPC, security group,
        subnets, ingress rules, RDS paramter group.

    Args:
        core (core.Construct): The application scope
    """
