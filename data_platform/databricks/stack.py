...
class DatabricksStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, **kwargs) -> None:
        ...
        cross_account_role = iam.Role(
            ...
            assumed_by=iam.AccountPrincipal(account_id="633372182605"),
        ...
        cross_account_policy = iam.Policy(
            ...
            statements=[
                ...
                iam.PolicyStatement(
                    ...
                    resources=[
                        f"arn:aws:s3:::s3-phtf-{self.deploy_env.value}-data-lake-*",
        ...
        bucket = s3.Bucket(
            self,
            id=f"s3-{self.deploy_env.value}-phtf-databricks-bucket",
            bucket_name=f"s3-{self.deploy_env.value}-phtf-databricks-bucket",
        )
